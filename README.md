...
./kafka-storage.sh format -t tCt51IHgR1eL9yIdnKozrw -c ../config/kraft/server-1.properties
./kafka-storage.sh format -t tCt51IHgR1eL9yIdnKozrw -c ../config/kraft/server-2.properties
./kafka-storage.sh format -t tCt51IHgR1eL9yIdnKozrw -c ../config/kraft/server-3.properties
...
services:
  kafka-1:
    ...
    ports:
      - "9091:9091"
    volumes:
      - ../kafka-volumes/server-1:/var/lib/kafka/data
  ...
  kafka-2:
    ...
    ports:
      - "9092:9092"
    volumes:
      - ../kafka-volumes/server-2:/var/lib/kafka/data
  ...
  kafka-3:
    ...
    ports:
      - "9093:9093"
    volumes:
      - ../kafka-volumes/server-3:/var/lib/kafka/data
